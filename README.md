...
### Setup
 was unable to run the project directly through IntelliJ due to missing 
...
- Login screen - entered credentials from Firebase and successfully logged in ✅
- Dashboard - loaded correctly showing GPA, active courses, due assignments, and overdue tasks ✅
- Add Course - worked as expected ✅
- Add Task - worked as expected ✅
- Tutor - worked as expected ✅
- Flashcard Maker - worked as expected ✅
- Grades Calculator - worked as expected ✅
- Toggle Dark Mode - Working properly ✅
- Logout not working ❌
